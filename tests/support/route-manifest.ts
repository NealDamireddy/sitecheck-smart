...
export const ROUTES: RouteSpec[] = [
  ...
  { file: 'api/projects/[projectId]/precipitation/route.ts', path: '/api/projects/[projectId]/precipitation', verbs: ['GET', 'POST'], scope: 'qsp', auth: 'user' },
  ...
  { file: 'api/inspections/[id]/checklist/submit/route.ts', path: '/api/inspections/[id]/checklist/submit', verbs: ['POST'], scope: 'qsp', auth: 'user' },
  { file: 'api/inspections/[id]/report-data/route.ts', path: '/api/inspections/[id]/report-data', verbs: ['GET'], scope: 'qsp', auth: 'user' },
  ...
  { file: 'api/inspector-workspace/route.ts', path: '/api/inspector-workspace', verbs: ['GET', 'POST', 'PATCH'], scope: 'qsp', auth: 'user' },
  { file: 'api/site-records/route.ts', path: '/api/site-records', verbs: ['GET', 'POST'], scope: 'qsp', auth: 'user' },
  { file: 'api/site-records/[id]/route.ts', path: '/api/site-records/[id]', verbs: ['GET'], scope: 'qsp', auth: 'user' },
  { file: 'api/site-records/[id]/uploads/route.ts', path: '/api/site-records/[id]/uploads', verbs: ['POST'], scope: 'qsp', auth: 'user' },
